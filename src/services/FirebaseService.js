...
export default {
    ...
    postMember(name, password, email, album, age) {
        firebase.auth().createUserWithEmailAndPassword(email, password).then(
            function(user) {
                ...
                signUpLog({ name: name, email: email }).then(function(result) {}).catch(function(error) {});
    ...
    loginWithGoogle() {
        ...
        return firebase.auth().signInWithPopup(provider).then(function(result) {
            ...
            signInLog({ access: "Google" }).then(function(result) {}).catch(function(error) {});
            return result
        }).catch(function(error) {
    ...
    loginWithFacebook() {
        ...
        return firebase.auth().signInWithPopup(provider).then(function(result) {
            ...
            let user = result.user
            var signInLog = firebase.functions().httpsCallable('signInLog');
            signInLog({ access: "Facebook" }).then(function(result) {}).catch(function(error) {});
            return result
        }).catch(function(error) {
